...
#EFFECTIVE LABELS IS THE LINE DOING THE MOST COMPLIANCE WORK - L16. CONSUMER CAN ADD LABELS TO VAR.LABELS, BUT CANNOT REMOVE REQUIRED_LABELS.
locals {
    required_labels = {
...
#SC-12: CRYPTOGRAPHIC KEY ESTABLISHMENT - WE OWN KEY, NOT GOOGLE
