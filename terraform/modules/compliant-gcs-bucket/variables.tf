...
variable "kms_location" {
    type            = string
    description     = "KMS keyring location. Must be a single region (multi-region not supported for keyrings)."
    default         = "us-central1"
}
...
variable "retention_days" {
    ...
    validation {
        ...
        error_message   = "retention_days must be between 1-3650."
    }
    validation {
...
variable "bucket_name_suffix" {
    ...
    validation {
        ...
        error_message   = "bucket_name_suffix must be 3-30 lowercase aplhanumerics or hyphens."
    }
}
